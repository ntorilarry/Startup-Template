...
export default class SimpleSlider extends Component {
  render() {
    ...
    return (
      <div className="dark:bg-[#0B0D39]" id="testimonials">
        <div
          data-aos="fade-up"
          data-aos-delay="1000"
          data-aos-once="true"
              ...
              <h2 className="max-w-lg mb-6 text-3xl font-bold leading-none tracking-tight text-center text-gray-900 sm:text-4xl md:mx-auto dark:text-white">
                ...
                <div className="flex flex-col items-center justify-center">
                  <div className="flex -space-x-4">
                    <img
                      alt=""
                      className="w-12 h-12 bg-gray-500 border border-gray-700 rounded-full"
                    ...
                    />
                    <span className="flex items-center justify-center w-12 h-12 font-semibold text-gray-100 bg-gray-900 border border-gray-700 rounded-full">
                      +3
                    </span>
                  </div>
                </div>
                ...
                <div className="w-full p-4">
                  <Slider {...settings}>
                    <div className=" bg-white dark:bg-[#2B2D5B] dark:text-white p-8 mx-4 rounded-2xl test">
                      ...
                      <a className="inline-flex items-center">
                        ...
                        <span className="flex flex-col flex-grow pl-4">
                          <span className="font-medium text-gray-900 title-font dark:text-white">
                            Holden Caulfield
                          </span>
                    ...
                    <div className="bg-white dark:bg-[#2B2D5B] dark:text-white mx-4 p-8 rounded-2xl test">
                      ...
                      <p className="mb-6 leading-relaxed dark:text-white">
                        Synth chartreuse iPhone lomo cray raw denim brunch
                        everyday carry neutra before they sold out fixie 90's
                        microdosing. Tacos pinterest fanny pack venmo,
                        post-ironic heirloom try-hard pabst authentic iceland.
