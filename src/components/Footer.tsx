...
function Footer() {
  return (
    <div className="bg-white dark:bg-[#0B0D39]">
      <section className="py-10sm:pt-16 lg:pt-24">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              ...
              <p className="text-base text-3xl sm:text-4xl leading-relaxed text-gray-600 mt-7 dark:text-white">
              Hello@Startup.com
              </p>
            ...
            <div>
              <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase dark:text-white">
                Company
              </p>
