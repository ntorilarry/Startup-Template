...
function Navbar() {
  ...
  return (
    <div className="dark:bg-[#0B0D39]">
      <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 md:shadow-2xl rounded-full dark:bg-[#1A1C46]">
        <div className="relative flex items-center justify-between">
          <div className="flex items-center">
            ...
            >
              <img src={Logo} alt="" />
              <span className="ml-2 text-xl font-medium tracking-wide text-gray-800 dark:text-white ">
                Start<span className="text-[#356DFF]">up</span>
              </span>
            </a>
